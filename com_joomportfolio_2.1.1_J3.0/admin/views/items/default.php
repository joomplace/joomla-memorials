...
<form action="<?php echo JRoute::_('index.php?option=com_joomportfolio&view=items'); ?>" method="post" name="adminForm"
      id="adminForm">
    <div class="clearfix">
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <!--<td class="order">
                                        <?php if ($this->canDo->get('core.edit')) : ?>
                                            <?php if ($saveOrder) : ?>
                                                <?php if ($listDirn == 'asc') : ?>
                                                                                                <span><?php echo $this->pagination->orderUpIcon($i, true, 'items.orderup', 'JLIB_HTML_MOVE_UP', $saveOrder); ?></span>
                                                                                                <span><?php echo $this->pagination->orderDownIcon($i, $this->pagination->total, true, 'items.orderdown', 'JLIB_HTML_MOVE_DOWN', $saveOrder); ?></span>
                                                <?php elseif ($listDirn == 'desc') : ?>
                                                                                                <span><?php echo $this->pagination->orderUpIcon($i, true, 'items.orderdown', 'JLIB_HTML_MOVE_UP', $saveOrder); ?></span>
                                                                                                <span><?php echo $this->pagination->orderDownIcon($i, $this->pagination->total, true, 'items.orderup', 'JLIB_HTML_MOVE_DOWN', $saveOrder); ?></span>
                                                <?php endif; ?>
                                            <?php endif; ?>
