...
<form action="<?php echo JRoute::_('index.php?option=com_joomportfolio&view=dashboard_items'); ?>" method="post"
        ...
        <div id="j-main-container">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    <label for="filter_search"
                           class="element-invisible"><?php echo JText::_('COM_JOOMPORTFOLIO_FILTER_SEARCH_DESC'); ?></label>
                    <input type="text" name="filter_search"
                           placeholder="<?php echo JText::_('COM_JOOMPORTFOLIO_FILTER_SEARCH_DESC'); ?>"
                           id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
                           title="<?php echo JText::_('COM_JOOMPORTFOLIO_FILTER_SEARCH_DESC'); ?>"/>
                </div>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th width="15%">
                        <?php echo JHtml::_('grid.sort', 'COM_JOOMPORTFOLIO_DASHBOARD_ITEM_URL', 'url', $listDirn, $listOrder); ?>
                    </th>
                    <th width="5%">
                        <?php echo JHtml::_('grid.sort', 'COM_JOOMPORTFOLIO_DASHBOARD_ITEM_ICON', 'icon', $listDirn, $listOrder); ?>
                    </th>
                    <th width="5%">
                ...
                <?php if (sizeof($this->items)) {
                    foreach ($this->items as $i => $item) {
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
                                <a href="<?php echo JRoute::_('index.php?option=com_joomportfolio&task=dashboard_item.edit&id=' . $item->id); ?>">
                    ...
                    <tr>
                        <td colspan="9" align="center">
                            <?php echo JText::sprintf('COM_JOOMPORTFOLIO_DASHBOARD_ITEMS_NONE', 'dashboard items'); ?>
                            <a href="<?php echo JRoute::_('index.php?option=com_joomportfolio&task=dashboard_item.add'); ?>">
                                <?php echo JText::_('COM_JOOMPORTFOLIO_DASHBOARD_ITEMS_NONE_A'); ?>
                            </a>
                        </td>
                    </tr>
                <?php } ?>
