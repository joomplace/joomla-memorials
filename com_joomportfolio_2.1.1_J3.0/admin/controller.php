...
class JoomPortfolioController extends JControllerLegacy {
    ...
    function latestVersion() {
        ...
        require_once dirname(__FILE__) . '/helpers/joomportfolio.php';
        $tm_version = JoomPortfolioHelper::getVersion();
        $s = new Snoopy();
        $s->read_timeout = 90;
        $s->referer = JURI::root();
        @$s->fetch('http://www.joomplace.com/version_check/componentVersionCheck.php?component=joomportfolio&current_version=' . urlencode($tm_version));
