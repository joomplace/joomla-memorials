...
class JFormFieldAudiotable extends JFormField
{
	public $type = 'audiotable';
	...
	public function getInput()
	{
        ...
        ob_start();
		include(dirname(__FILE__).DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'audiotable.tmpl.php');
		$inputer = ob_get_contents();
		ob_get_clean();
            return $inputer;
        } else {
            return JText::_('COM_JOOMPORTFOLIO_SAVE_ITEM_BEFORE_ADD_AUDIO');
        }
